    ...
    ILogger<RealtimeNotifier> logger) : IRealtimeNotifier
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        foreach (var userId in distinctUserIds)
        {
            ...
            var envelope = BuildEnvelope(eventType, "user", target, payload);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var envelope = BuildEnvelope(eventType, "conversation", groupName, payload);
    ...
    private RealtimeEnvelope BuildEnvelope(string eventType, string scope, string target, object payload)
    {
